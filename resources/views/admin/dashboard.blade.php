<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 px-4 sm:px-0">
            ...
            {{-- Badge Role Akses - Terintegrasi dengan Multiple Roles --}}
            <div class="flex items-center gap-3 bg-white p-2 pr-4 rounded-2xl shadow-sm border border-slate-100">
                ...
                <div class="flex flex-col">
                    <span class="text-[9px] font-black uppercase tracking-[0.15em] text-slate-400 line-height-1">
                        Mode Akses @if(count(array_merge([Auth::user()->role], (Auth::user()->roles ?? []))) > 1) <span class="text-indigo-500">(Multi)</span> @endif
                    </span>
            ...
            <div class="bg-white shadow-xl shadow-slate-200/50 sm:rounded-[2.5rem] border border-slate-100 overflow-hidden">
                <div class="p-4 md:p-8">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                        ...
                        {{-- Tombol Tambah Murid: Hanya untuk Admin Dojo atau PB --}}
                    ...
                    <div class="bg-slate-50/80 rounded-3xl p-4 md:p-6 mb-8 border border-slate-100">
                        <form method="GET" action="{{ route('admin.dashboard') }}"
                            ...
                            <div class="lg:col-span-2 flex gap-2">
                                <button type="submit" class="flex-1 bg-slate-800 text-white px-4 py-2.5 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-sm">Filter</button>
